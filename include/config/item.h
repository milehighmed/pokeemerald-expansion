...
// Exp. Share config
#define I_EXP_SHARE_FLAG        FLAG_UNUSED_0x282          // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
