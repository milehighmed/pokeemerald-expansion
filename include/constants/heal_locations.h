...
#define HEAL_LOCATION_DESOLATE_CHECKPOINT 1
#define HEAL_LOCATION_DUNETOWN 2
...
#define HEAL_LOCATION_WATT_JUNCTION 23
#define HEAL_LOCATION_THE_BRICKS 24
#define HEAL_LOCATION_LAKE_LORAL 25
