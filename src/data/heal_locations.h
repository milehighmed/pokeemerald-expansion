...
{
    [HEAL_LOCATION_DESOLATE_CHECKPOINT - 1] = {MAP_GROUP(DESOLATE_CHECKPOINT), MAP_NUM(DESOLATE_CHECKPOINT), 17, 9},
    [HEAL_LOCATION_DUNETOWN - 1] = {MAP_GROUP(DUNETOWN), MAP_NUM(DUNETOWN), 22, 16},
    ...
    [HEAL_LOCATION_WATT_JUNCTION - 1] = {MAP_GROUP(WATT_JUNCTION), MAP_NUM(WATT_JUNCTION), 8, 22},
    [HEAL_LOCATION_THE_BRICKS - 1] = {MAP_GROUP(THE_BRICKS), MAP_NUM(THE_BRICKS), 8, 24},
    [HEAL_LOCATION_LAKE_LORAL - 1] = {MAP_GROUP(LAKE_LORAL), MAP_NUM(LAKE_LORAL), 23, 18},
};
